module YmContent::RedactorImageUploadsController
  def self.included(base)
    base.load_and_authorize_resource if respond_to?(:load_and_authorize_resource)
    base.skip_before_filter :verify_authenticity_token, :only => :create
  end
